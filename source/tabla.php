                ...
                <table id="tablaEmpleados" class="table table-striped  border    table-bordered dataTable"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <?php echo "<td>  <a href='modif_prod1.php?no=".$row['ID']."'> <button type='button' class='btn btn-success'>Modificar</button> </a> </td>";?>
                            <?php echo "<td> <a href='eliminar_prod.php?no=".$filas['ID']."''><button type='button' class='btn btn-danger'>Eliminar</button></a> </td>";?>
                            <td>
